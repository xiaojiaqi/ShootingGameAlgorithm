void MoveReflectShot(
	float& x0, float& y0,      // ƒV?ªóƒg‚Ì¶ãÀ•W
	float& x1, float& y1,      // ƒV?ªóƒg‚Ì…¸‰ºÀ•W
	float& vx, float& vy,      // ƒV?ªóƒg‚Ì‘¬Ãgi?•½C?’¼j
	...
	// ’nŒ`‚Æ‚Ì?‚½‚è”»ƒ]??F
	// ƒV?ªóƒg‚ð?’¼•ûÅØ‚Éi‚ß‚½À•W‚É‚Â‚¢‚ÄC
	// ’nŒ`‚É?‚½‚é‚©‚Ç´Ó‚©‚ð”»ƒ]‚·‚éB
	// ’nŒ`‚É?‚½‚Á‚½ê?‚É‚ÍC?’¼•ûÅØ‚Ì‘¬Ãg‚ðÊä‚É‚µ‚ÄC
	// ?[ƒv‚©‚ç”²‚¯‚éB
